...
export default function HorizontalScroll({
  ...
  return (
    <ReactLenis root>
      <section ref={sectionRef} className="relative h-[200vh] lg:h-[300vh]">
        <ul ref={ulRef} className="sticky top-0 flex">
          <li className="bg-primary-green flex h-screen w-screen min-w-screen flex-col items-center justify-start overflow-hidden pt-20">
            ...
            <p className="text-primary-blue relative bottom-5 inline-block max-w-5xl px-8 text-center text-lg lg:text-2xl">
          ...
          <li className="bg-primary-blue hidden h-screen w-screen min-w-screen flex-col items-center justify-start overflow-hidden pt-20 lg:flex">
            <h2 className="text-primary-green relative bottom-5 inline-block text-[10vw] font-semibold">
              {aboutUs?.ourMission.title}
            </h2>
            <p className="text-primary-green relative bottom-5 inline-block max-w-5xl px-8 text-center text-lg lg:text-2xl">
      ...
      <div className="bg-primary-blue flex h-screen w-screen min-w-screen flex-col items-center justify-start overflow-hidden pt-20 lg:hidden">
        <h2 className="text-primary-green relative bottom-5 inline-block text-[10vw] font-semibold">
          {aboutUs?.ourMission.title}
        </h2>
        <p className="text-primary-green relative bottom-5 inline-block max-w-5xl px-8 text-center text-lg lg:text-2xl">
